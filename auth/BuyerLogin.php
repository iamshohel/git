...
<link rel="icon" href="../FarmerPortal/agro.png">
...
<body>
    ...
    <main class="my-form">
        ...
        <br>
        <a href="../index.html"><img src="../FarmerPortal/agro.png" class="float-left mr-4 ml-10 " alt="Logo" style="margin-left:40%;" height="250px"></a>
